...
import weaverImage from '../assets/weaver.png'
...
export function WelcomePage() {
  ...
  return (
    <>
      <Helmet>
        <title>首页 - {SITE_CONFIG.name}</title>
          ...
          <div className="flex items-center justify-between px-5 py-5 md:px-7 md:py-7">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-3 text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
                由我编写的泛微开发手册，包含前端和后端，E9 和 E10 两个系统，以及包括多个案例
              </p>
              <Link
                to={`/articles/view?path=${encodeURIComponent('/api/docs-static/泛微开发/README.md')}`}
        ...
        <section className="mb-12 -mx-3 md:-mx-4 lg:-mx-6">
          <div className="max-w-6xl mx-auto px-3 md:px-4 lg:px-6">
            ...
            {groupedArticles.groups.map(({ category, articles }) => (
              <div key={category.id} className="w-[400px] shrink-0 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm overflow-hidden transition-all hover:border-blue-400/40 hover:shadow-[0_0_14px_rgba(96,165,250,0.12)]">
            ...
            {groupedArticles.uncategorized.length > 0 && (
              <div className="w-[400px] shrink-0 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm overflow-hidden transition-all hover:border-blue-400/40 hover:shadow-[0_0_14px_rgba(96,165,250,0.12)]">
                <div className="px-4 py-3 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            {profile.image && (
              <div className="w-full sm:w-1/2 flex items-start">
                  <img
                    src={profile.image}
                    alt="个人图片"
                    className="max-h-[400px] max-w-full rounded-2xl object-contain [clip-path:inset(0_round_0.75rem)]"
                  />
              </div>
            )}
            <div className="w-full sm:w-1/2">
              {profile.content ? (
                ...
                <p className="text-zinc-700 dark:text-zinc-300">你好，我是一名开发者</p>
              )}
            </div>
          </div>
        </section>
      ...
      <div className="bg-black text-white py-16">
        <div className="grid w-full gap-10 md:grid-cols-2 md:items-stretch">
          <div className="flex min-h-40 items-center justify-center text-center">
            <div className="text-6xl font-bold tracking-normal text-white sm:text-7xl md:text-8xl">
              {SITE_CONFIG.siteId}
            </div>
          </div>
          <div className="flex min-h-40 flex-col items-center justify-center text-center">
            <p className="text-base mb-1 text-zinc-200">你喜欢这个网站吗？</p>
            <p className="text-base mb-8 text-zinc-400">此网站是开源的，点击下方查看开源项目</p>
            <a
              href="https://github.com/YaoLilin/blog-website"
              target="_blank"
              rel="noopener noreferrer"
