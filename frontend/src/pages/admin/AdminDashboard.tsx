  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link to="/admin/articles" className="p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 transition-colors">
        ...
        <Link to="/admin/stats" className="p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 transition-colors">
        ...
        <Link to="/admin/git" className="p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 transition-colors">
